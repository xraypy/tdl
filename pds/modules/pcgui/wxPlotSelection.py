...
class wxPlotSelection(model.Background, wxUtil):
    ...
    def init_XItems(self):
        ...
        self.components.X.items = self.list_data()
    ...
    def init_YItems(self):
        ...
        self.components.Y.items = self.list_data()
    ...
    def init_XerrItems(self):
        ...
        self.components.Xerr.items = self.list_data()
    ...
    def init_YerrItems(self):
        ...
        self.components.Yerr.items = self.list_data()
    ...
    def init_SaveNameItems(self):
        ...
        self.components.SaveName.items = self.list_data()
