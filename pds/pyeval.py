...
Description:
------------ 
This module sets up a clean name-space for execution
of python commands/code.  VAR_DICT should be a dictionary
defined in another module that keeps track of it.  E.g. in shell
...
def do_exec(exec_str,vars={}):
    ...
    line continuations if exec_str is a string.
    Use code.InteractiveConsole module for full python emulation
    or compile the multiline code bit and pass the compiled
    code here for execution.  
    """
