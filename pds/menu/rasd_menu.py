...
from   pds.shellutil import Menu 
from   pds.shellutil import get_tf, get_yn, get_int
from   pds.shellutil import get_flt, get_str, get_flt_list

from   tdl.modules.ana import rasd_ana
...
RASD_DESCR = ["Plot scan with (default) or without normalization",
             ...
             "Run simulated annealing structure refinement",
             "Select scan",
             "Select next scan ",
