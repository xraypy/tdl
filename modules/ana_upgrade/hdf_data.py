...
Todo:
-----
* HdfDataFile also needs search / filter methods that return lists of point numbers
...
class HdfDataFile:
    ...
    def get_all(self, key, points=None):
        ...
        To ensure the returned values are up to date, writes
        the current point to the file first.
    ...
    def read_point(self,num):
        ...
        while True:
            try:
                ...
                self.point_dict[det_str]['image_data'] = \
                        self.file[num][det_str]['image_data']
                for key in DET_KEYS:
                    key_loc = DET_KEYS[key]
...
if __name__ == "__main__":
    ...
    #test_grp.create_dataset('ones',data=num.ones(10))
    #test_grp['xx'] = 'a string'
    #file.close()
    #
    #d = HdfDataFile('bob.h5')
    #testObject = HdfDataFile('C:\\Users\\biwer\\Desktop\\HDFFiles\\ProjectFULLALLv3.h5')
    testObject = HdfDataFile('C:\\Users\\biwer\\Desktop\\HDFFiles\\TinyRodscansEmpty.h5')
